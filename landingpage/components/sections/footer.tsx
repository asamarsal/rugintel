        ...
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              <div className="w-8 h-8 border-2 border-cyan-400 flex items-center justify-center font-mono text-cyan-400 text-sm font-bold">
                RI
              </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400 text-sm">
              ...
              <li><a href="#" className="hover:text-cyan-400 transition">Telegram</a></li>
