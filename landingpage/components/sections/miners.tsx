    ...
    <section className="py-20 px-6 bg-gradient-to-b from-black via-purple-950/10 to-black">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-5xl md:text-6xl font-bold font-mono mb-4 text-purple-400">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          <NeonBorder color="magenta" className="bg-black/60 p-8">
            <h3 className="text-2xl font-bold text-magenta-400 mb-4 font-mono">
              How Mining Works
            </h3>
            <ol className="space-y-3">
              {[
                ...
                <li key={idx} className="flex gap-3 text-gray-300">
                  <span className="text-magenta-400 font-bold flex-shrink-0">
                    {idx + 1}.
                  </span>
                  <span>{step}</span>
                </li>
          ...
          <div className="space-y-4">
            ...
            <NeonBorder color="lime" className="bg-lime-500/5 p-6">
              <div className="text-sm text-lime-400 font-mono mb-1">
                MINIMUM STAKE
              </div>
              <div className="text-4xl font-bold text-lime-400 font-mono">
                1,000 RUIN
              </div>
              <p className="text-gray-400 text-sm mt-2">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
          {minerBenefits.map((benefit, idx) => (
            <NeonBorder
              key={idx}
              color={
                idx % 3 === 0 ? "cyan" : idx % 3 === 1 ? "magenta" : "lime"
              }
