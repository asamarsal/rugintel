...
export function RugpullChart() {
  return (
    <div className="py-16 px-6 bg-gradient-to-b from-black to-slate-900/20">
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="border border-lime-500/30 bg-lime-500/5 p-6 rounded-lg">
            <div className="flex items-center gap-3 mb-3">
              ...
              <span className="text-lime-400 font-mono font-bold uppercase tracking-wide">Protected</span>
            </div>
          ...
          <div className="border border-red-500/30 bg-red-500/5 p-6 rounded-lg">
            <div className="flex items-center gap-3 mb-3">
              ...
              <span className="text-red-400 font-mono font-bold uppercase tracking-wide">Rugpull Detected</span>
            </div>
            <p className="text-gray-300">
